 ...
 */
public class ld_nine {
	private int x, y, w, h, ts;
	private Texture t;
	private NinePatch np;
	public ld_nine(Texture t, int x,int y,int w,int h,int tilesize){
		this.x = x;
		this.y = y;
		this.w = w;
		this.h = h;
	...
	public ld_nine(Texture t, int x,int y,int w,int h,int tilesize, SpriteBatch batch){
		x = x;
		y = y;
		w = w;
		h = h;
